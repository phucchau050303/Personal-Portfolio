import {
  Container_default
} from "./chunk-Z2EJSIXO.js";
import {
  Row_default
} from "./chunk-52CHJP7H.js";
import {
  Col_default,
  useCol
} from "./chunk-SUD3SKCL.js";
import {
  Image_default,
  propTypes
} from "./chunk-MOF3KGRU.js";
import {
  arrow_default,
...
} from "./chunk-WO4JZASA.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-2FQOFYS6.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react34.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react44.useLayoutEffect : import_react44.useEffect;
...
var FormGroup = React57.forwardRef(({
  ...
  const context5 = (0, import_react53.useMemo)(() => ({
    controlId
  }), [controlId]);
...
function useMergedRefs2(refA, refB) {
  return (0, import_react58.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
function useNavItem({
  ...
  const navContext = (0, import_react59.useContext)(NavContext_default);
...
var Nav = React69.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react60.useRef)(false);
  ...
  const listNode = (0, import_react60.useRef)(null);
...
function useCallbackRef2() {
  return (0, import_react61.useState)(null);
}
...
function useUpdatedRef2(value) {
  const valueRef = (0, import_react62.useRef)(value);
  valueRef.current = value;
  return valueRef;
}
...
function useWillUnmount2(fn) {
  ...
  (0, import_react63.useEffect)(() => () => onUnmount.current(), []);
}
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react64.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const child = (0, import_react65.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react66.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react66.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react66.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react66.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react66.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react66.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react66.useCallback)(normalize(addEndListener), [addEndListener]);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react67.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react67.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react68.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react68.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react68.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react68.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react68.useState)(!show);
  const lastFocusRef = (0, import_react68.useRef)(null);
  (0, import_react68.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react68.useRef)();
  const removeKeydownListenerRef = (0, import_react68.useRef)();
  ...
  return (0, import_jsx_runtime68.jsx)(import_jsx_runtime68.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, {
...
var AbstractModalHeader = React79.forwardRef(({
  ...
  const context5 = (0, import_react69.useContext)(ModalContext_default);
...
var Modal2 = React82.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react70.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react70.useState)(false);
  const waitingForMouseUpRef = (0, import_react70.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react70.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react70.useRef)(null);
  ...
  const renderBackdrop = (0, import_react70.useCallback)((backdropProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...backdropProps,
...
var Nav2 = React85.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react71.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react71.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React87.forwardRef(({
  ...
  const context5 = (0, import_react72.useContext)(NavbarContext_default);
...
var NavbarToggle = React88.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react73.useContext)(NavbarContext_default) || {};
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react74.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react75.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React93.forwardRef(({
  ...
  const modalManager = (0, import_react76.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react76.useState)(false);
  const handleHide = useEventCallback(onHide);
  const hideResponsiveOffcanvas = useBreakpoint_default(responsive || "xs", "up");
  (0, import_react76.useEffect)(() => {
    setShowOffcanvas(responsive ? show && !hideResponsiveOffcanvas : show);
  }, [show, responsive, hideResponsiveOffcanvas]);
  const modalContext = (0, import_react76.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  function getModalManager() {
    if (propsManager) return propsManager;
  ...
  const renderBackdrop = (0, import_react76.useCallback)((backdropProps) => (0, import_jsx_runtime87.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React94.forwardRef(({
  ...
  const context5 = (0, import_react77.useContext)(NavbarContext_default);
...
var Navbar = React96.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react78.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react78.useMemo)(() => ({
...
var Overlay = React98.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react80.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react81.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React104.forwardRef(({
  ...
  const popperRef = (0, import_react82.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react82.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react83.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, getChildRef(children));
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react83.useRef)("");
  ...
  const handleShow = (0, import_react83.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react83.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react83.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react83.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react83.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react83.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react83.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime104.jsxs)(import_jsx_runtime103.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react83.cloneElement)(children, triggerProps), (0, import_jsx_runtime102.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ProgressBar = React110.forwardRef(({
  ...
  return (0, import_jsx_runtime110.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react84.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react85.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react86.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react86.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React123.forwardRef(({
  ...
  const context5 = (0, import_react87.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React125.forwardRef(({
  ...
  const delayRef = (0, import_react88.useRef)(delay);
  const onCloseRef = (0, import_react88.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react88.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react88.useMemo)(() => ({
    onClose
  }), [onClose]);
