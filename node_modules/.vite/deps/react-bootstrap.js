...
var Modal = (0, import_react69.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, {
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React120.forwardRef(({
    children,
    ...props
...
var Spinner = React126.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React127.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React129.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var ToastFade = React135.forwardRef((props, ref) => (0, import_jsx_runtime137.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React136.createContext({
  onClose() {
  }
});
...
var ToastHeader = React137.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastBody = React138.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React140.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React141.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React142.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
